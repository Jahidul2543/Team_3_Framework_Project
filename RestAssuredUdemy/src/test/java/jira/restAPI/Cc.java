...
public class Cc {
    ...
    public void verifyResponse() throws IOException{
        ...
        Response  res = given().                                          // given = request header, param, cookies, request body
                contentType(ContentType.JSON).
                body(requestBody).
                when().                                                   // when = type of request
                post("/rest/auth/1/session").
                then().assertThat().statusCode(200).                      // then = Assertion

                extract().response();                                      // extract = where you
        ...
        // Add Comment
        String createCmntBody = generateString("UpdateComment.json");
